...
There is a reason this treatment is booked before weddings, shoots and big
birthdays: it delivers a visible glow in well under an hour, with nothing to
hide afterwards.
...
intensity of each step can be dialled up or down for sensitive, reactive or
congestion-prone skin.

## What we recommend

Monthly is the sweet spot for maintaining the result, and it layers beautifully
with a considered home routine. Start gentle, stay consistent, and let a
